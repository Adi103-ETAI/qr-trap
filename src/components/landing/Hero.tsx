    ...
    <section className="relative overflow-hidden border-b border-border cyber-grid">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-24 lg:py-32 flex flex-col items-center text-center gap-6">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative h-72 w-72 sm:h-80 sm:w-80 lg:h-96 lg:w-96 rounded-2xl overflow-hidden bg-card/40 border border-border flex items-center justify-center shadow-[0_0_40px_rgba(220,38,38,0.3)]">
            <Image
